    ...
    <div className="matchup-page">
      ...
      <main className="matchup-content">
        ...
        <section className="matchup-vote-stage" aria-label="Tap a contender to cast your vote">
          ...
          {/* The "Can't decide? Skip" affordance was removed in a UX
              call — pairwise-skip is a sequential-flow optimisation
              that doesn't fit the single-matchup detail surface.
              Backend (SkipMatchup RPC + matchup_votes.kind column) is
              kept dormant for a possible future bracket-play surface
              where sequential skip semantics actually apply. */}
        </section>
